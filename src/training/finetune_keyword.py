...
class KeywordSummaryDataset(Dataset):
    def __init__(self, filepath, tokenizer, max_input_len=384, max_output_len=32):
        self.samples = []
...
# 데이터 로딩
train_dataset = KeywordSummaryDataset("summary_keyword_train.jsonl", tokenizer)
val_dataset = KeywordSummaryDataset("summary_keyword_val.jsonl", tokenizer)
...
save_path = "kot5-keyword-summary"
...
for epoch in range(epochs):
    ...
    # 검증
    model.eval()# 키워드 요약 모델 학습 코드 (Colab용)
